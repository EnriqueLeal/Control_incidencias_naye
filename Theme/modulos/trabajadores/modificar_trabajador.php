...
<!-- inicio lista personas -->
    <section id="lPersonas">
      ...
      <?php
              ...
              $consulta = mysql_query("SELECT id_trabajador, p.nombre,p.ap_paterno,p.ap_materno
                    FROM trabajadores 
                    INNER JOIN personas p
                    ON trabajadores.id_persona = p.id_persona
