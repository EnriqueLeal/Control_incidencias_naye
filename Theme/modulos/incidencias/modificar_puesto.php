...
<!-- inicio lista personas -->
    <section id="lPersonas">
      ...
      <?php
              ...
              $consulta = mysql_query("SELECT id_incidencia, num_tipo_usuario
                    FROM incidencias 
                    WHERE id_incidencia = '$id'",$conexion) or die (mysql_error());
            ...
            <form action="ejecutar_modificar_puestos.php" method="POST" id="formulario">
                <input type="hidden" class="form-control" id="id_incidencia" value="<?php echo $row[0];?>" name="id_incidencia">
              <div class="form-group col-md-4">
                <label for="nom_puesto">Nombre: </label>
                <input type="text" class="form-control" id="num_tipo_usuario" value="<?php echo $row[1];?>" name="num_tipo_usuario">
              </div>
