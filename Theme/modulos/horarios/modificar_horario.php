...
<!-- ////////////////////////////////////////////////////////////////////////////////////////////////////////////inicio lista PERSONAS 2 -->
    <section id="lHorario">
                ...
                <div class="col-lg-8">
                          <form id="frmNuevo" method="post" class="form-vertical" action="">
                                    ...
                                    <div class="panel-heading">
                                        <h2>HORARIOS - Editar Registros</h2>
                                    </div>

                                    <div class="panel-body">
                                        <!-- inicio del datatable -->
                                   <div class="table-responsive">
                                        <section id="llenar_horarios"></section>
                                   </div>
                                        <!-- fin del datatable -->
                                    </div>
      ...
      <?php
              ...
              $consulta = mysql_query("SELECT id_horario, nombre_horario, hora_entrada, hora_salida
                    FROM horarios 
                    WHERE id_horario = '$id'",$conexion) or die (mysql_error());
            ...
            <form action="ejecutar_modificar_usuarios.php" method="POST" id="formulario">
                <input type="hidden" class="form-control" id="id_horario" value="<?php echo $row[0];?>" name="id_horario">

              
              <div class="form-group col-md-4">
                <label for="nombre_horario">Nombre horario: </label>
                <input type="text" class="form-control" id="nombre_horario" value="<?php echo $row[1];?>" name="nombre_horario">
              </div>

              <div class="form-group col-md-4">
                <label for="hora_entrada">Hora entrada: </label>
                <input type="text" class="form-control" id="hora_entrada" value="<?php echo $row[2];?>" name="hora_entrada">
              </div>

              <div class="form-group col-md-4">
                <label for="hora_salida">Hora salida: </label>
                <input type="date" class="form-control" id="hora_salida" value="<?php echo $row[3];?>" name="hora_salida">
              </div>
