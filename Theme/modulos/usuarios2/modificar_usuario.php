...
<!-- ////////////////////////////////////////////////////////////////////////////////////////////////////////////inicio lista PERSONAS 2 -->
    <section id="lUsuario">
                ...
                <div class="col-lg-11">
                          <form id="frmNuevo" method="post" class="form-vertical" action="">
                                    ...
                                    <div class="panel-heading">
                                        <h2>USUARIOS - Editar Registros</h2>
                                    </div>

                                    <div class="panel-body">
                                        <!-- inicio del datatable -->
                                   <div class="table-responsive">
                                        <section id="llenar_usuarios"></section>
                                   </div>
                                        <!-- fin del datatable -->
                                    </div>
      ...
      <?php
              ...
              $consulta = mysql_query("SELECT u.id_usuario, CONCAT(p.nombre, ' ', p.ap_paterno, ' ',  p.ap_materno), u.nom_usuario, u.contra, u.caducidad
                    FROM usuarios AS u INNER JOIN personas AS p
                    WHERE u.id_usuario = '$id' AND p.id_persona = '$id'",$conexion) or die (mysql_error());
            ...
            ?>
            <form action="ejecutar_modificar_usuarios.php" method="POST" id="formulario">
                <input type="hidden" class="form-control" id="id_usuario" value="<?php echo $row[0];?>" name="id_usuario">

                <div class="form-group col-md-4">
                          <div class="form-group">
                              <label for="persona">Persona:</label>
                        <input type="text" name="persona" class="form-control mayus" id="persona" value="<?php echo $row[1];?>" readonly> 
                          </div>                                    
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="nom_usuario" value="<?php echo $row[2];?>" name="nom_usuario">
              </div>

              <div class="form-group col-md-4">
                <label for="caducidad">Caducidad: </label>
                <input type="date" class="form-control" id="caducidad" value="<?php echo $row[4];?>" name="caducidad">
              </div>
              <br> <br><br><br>
            <div class="form-group col-md-4">
