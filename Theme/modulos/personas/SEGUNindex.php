            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <br>
                    <center><h2 style="color: #3498db;">PERSONAS</h2></center>    
                    <br>
                    <br>
            ...
            <div class="container-fluid">
                <div class="col-lg-11">
                    <div class="panel-heading">
                          ...
                          <form id="frmNuevoAlumno" method="post" class="form-vertical">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="error">
                                                    <input class="form-control" id="correo" autofocus placeholder="Coloca el correo" name="correo" required>
                                                    </div>
                                                </div>               
                                            </div>
                                         ...
                                         <div class="row"> 
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                                             ...
                                             <br><br><br>
                                        <input type="submit" name="AlumnoG" value="Guardar" class="btn btn-primary btn-main center-block" >
                                </div>
