...
<aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><a href="../../inicio/index.php"><img src="../../assets/img/logo.png" class="img-circle" width="60"></a></p>
...
<!-- ////////////////////////////////////////////////////////////////////////////////////////////////////////////inicio lista PERSONAS 2 -->
    <section id="lPersonas2">
                ...
                <div class="col-lg-11">
                          <form id="frmNuevo2" method="post" class="form-vertical" action="">
                                    ...
                                    <div class="panel-heading">
                                        <h2>PERSONAS - Editar Registros</h2>
                                    </div>

                                    <div class="panel-body">
                                        <!-- inicio del datatable -->
                                   <div class="table-responsive">
                                        <section id="llenar_personas2"></section>
                                   </div>
                                        <!-- fin del datatable -->
                                    </div>
      ...
      <?php
            ...
            ?>
            <form  id="formulario">
                <input type="hidden" class="form-control" id="id_persona" value="<?php echo $row[0];?>" name="id_persona">


              <div class="form-group col-md-4">
                <label for="nombre">Nombre: </label>
                <input type="text" class="form-control" id="nombre" value="<?php echo $row[1];?>" name="nombre">
              </div>

              <div class="form-group col-md-4">
                <label for="ap_paterno">Apellido Paterno: </label>
                <input type="text" class="form-control" id="ap_paterno" value="<?php echo $row[2];?>" name="ap_paterno">
              </div>

              <div class="form-group col-md-4">
                <label for="ap_materno">Apellido Materno: </label>
                <input type="text" class="form-control" id="ap_materno" value="<?php echo $row[3];?>" name="ap_materno">
              </div>

              <div class="form-group col-md-4">
                <label for="correo">E-mail: </label>
                <input type="text" class="form-control" id="correo" value="<?php echo $row[4];?>" name="correo">
              </div>

              <div class="form-group col-md-4">
                <label for="telefono">Teléfono: </label>
                <input type="text" class="form-control" id="telefono" value="<?php echo $row[5];?>" name="telefono">
              </div>
             ...
             <div class="form-group col-md-4">
             <a href="javascript:Actualizar_Personas2($('#id_persona').val());" class="btn btn-primary btn-main center-block"></a>
               <input type="submit" value="Actualizar"  onclick="javascript:Actualizar_Personas2($('#id_persona').val());" class="btn btn-primary btn-main center-block">
             </div>
